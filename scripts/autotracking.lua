...
function updateLocationsFromMemorySegmentCorridor(segment)
    ...
    if AUTOTRACKER_ENABLE_LOCATION_TRACKING then
        ...
        updateSectionMultipleChestCountFromByteAndFlag(segment, "@Cardia Forest/Chests", { [0x6284] = 0x04, [0x6285] = 0x04, [0x6286] = 0x04, [0x6287] = 0x04, [0x6288] = 0x04, [0x628F] = 0x04, [0x6290] = 0x04 })
